...
require("./modules/intro-video");
require("./modules/intro-slider");
require("./modules/tours-slider");
require("./modules/education-slider");
require("./modules/reviews-slider");
var _advantagesSlider = require("./modules/advantages-slider");
require("./modules/gallery-slider");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _advantagesSlider.initResize)();
...
},{"./modules/advantages-slider":2,"./modules/education-slider":3,"./modules/form-validate/form":5,"./modules/gallery-slider":11,"./modules/intro-slider":12,"./modules/intro-video":13,"./modules/main-nav":14,"./modules/modals/init-modals":15,"./modules/reviews-slider":17,"./modules/tours-slider":18,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initResize = exports.initAdvantagesSlider = void 0;
...
var convertSwiper = function convertSwiper() {
...
var initResize = exports.initResize = function initResize() {
  convertSwiper();
};
...
exports.educationSwiper = void 0;
var educationSwiper = exports.educationSwiper = new window.Swiper('.education__slider', {
  navigation: {
...
var gallerySwiper = exports.gallerySwiper = new window.Swiper('.gallery__slider', {
  loop: true,
  navigation: {
...
exports.introSwiper = void 0;
var introSwiper = exports.introSwiper = new window.Swiper('.intro__slider', {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 0,
  pagination: {
...
var video = document.querySelector('.intro__media-container');
var videoButton = document.querySelector('.intro__media-button');
window.addEventListener('DOMContentLoaded', function () {
  videoButton.addEventListener('click', function () {
    ...
    video.insertAdjacentHTML('afterbegin', '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/9TZXsZItgdw?si=Ds6XaCVooRkUI8UE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>');
  });
  return false;
});
...
var mainHeaderWrapper = document.querySelector('.main-header__wrapper');
var navToggle = document.querySelector('.main-header__toggle');
var mainHeaderLogo = document.querySelector('.main-header__logo-link');
var phoneNumberLink = document.querySelector('.main-header__contact-number-link');
...
navToggle.addEventListener('click', function () {
  if (navMain.classList.contains('main-nav--closed')) {
    ...
    phoneNumberLink.classList.remove('main-header__contact-number-link--switch');
...
mainNavLink.forEach(function (button) {
...
var reviewsSwiper = exports.reviewsSwiper = new window.Swiper('.reviews__slider', {
  loop: true,
  navigation: {
...
var toursSwiper = exports.toursSwiper = new window.Swiper('.tours__slider', {
  navigation: {
